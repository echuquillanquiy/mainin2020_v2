...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('web/assets/css/Pe-icon-7-stroke.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('web/assets/css/style.min.css') }}">
  ...
  <body id="home">
    ...
    <!-- begin:header -->
    <div class="header" data-parallax="scroll" data-image-src="{{ asset('web/assets/img/img-header.jpg') }}">
      <!-- begin:topbar -->
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="site-branding">
                  <h1 class="site-title title-image"><a href="#home" rel="home"><img src="{{ asset('web/assets/img/img-logo.png') }}" alt="construction business" class="img-responsive"></a></h1>
                </div><!-- .site-branding -->
              </div><!-- .col-sm-3 -->

              <div class="col-sm-9">
                <nav id="site-navigation" class="main-navigation" role="navigation">
                  <button type="button" class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><span class="pe-7s-menu"></span><span class="sr-only">Primary Menu</span></button>
                  ...
                  <div class="menu-testing-menu-container">
                    <ul id="primary-menu" class="menu nav-menu" aria-expanded="false">
                      ...
                      <li class="menu-item"><a href="#work">Projects</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <div class="blog-entry">
              <a href="#" class="blog-entry-thumbnail">
                <img src="{{ asset('web/assets/img/img-service-01.jpg') }}" alt="metal roofting" class="img-responsive">
              </a>
          ...
          <div class="col-md-4">
            <div class="blog-entry">
              <a href="#" class="blog-entry-thumbnail">
                <img src="{{ asset('web/assets/img/img-service-02.jpg') }}" alt="green building" class="img-responsive">
              </a>
              <div class="blog-entry-header">
            ...
            <ul class="blog-entry-list">
              <li>
                <span class="entry-post-thumbnail">
                  <img src="{{ asset('web/assets/img/img-service-03.jpg') }}" alt="construction Consultant">
                </span>
              ...
              <li>
                <span class="entry-post-thumbnail">
                  <img src="{{ asset('web/assets/img/img-service-04.jpg') }}" alt="General Contracting">
                </span>
                <div class="entry-post-content">
              ...
              <li>
                <span class="entry-post-thumbnail">
                  <img src="{{ asset('web/assets/img/img-service-05.jpg') }}" alt="Construction Management">
                </span>
                <div class="entry-post-content">
              ...
              <li>
                <span class="entry-post-thumbnail">
                  <img src="{{ asset('web/assets/img/img-service-06.jpg') }}" alt="House Renovation">
                </span>
                <div class="entry-post-content">
          ...
          <div class="col-md-12">
            ...
            <ul class="work-grid">
              <li class="work-item buildings">
                <a href="{{ asset('web/assets/img/img-work-01.jpg') }}" title="Avenue Hotels" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-01.jpg') }}" alt="Avenue Hotels">
                  </div><!-- .work-item-image -->
              ...
              <li class="work-item interior-design">
                <a href="{{ asset('web/assets/img/img-work-02.jpg') }}" title="Mark Bedroom" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-02.jpg') }}" alt="Mark Bedroom">
                  </div><!-- .work-item-image -->
                  <div class="work-item-info">
              ...
              <li class="work-item buildings">
                <a href="{{ asset('web/assets/img/img-work-03.jpg') }}" title="Edu Hostel" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-03.jpg') }}" alt="Edu Hostel">
                  </div><!-- .work-item-image -->
                  <div class="work-item-info">
              ...
              <li class="work-item isolation house-renovation">
                <a href="{{ asset('web/assets/img/img-work-04.jpg') }}" title="Alan Home" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-04.jpg') }}" alt="Alan Home">
                  </div><!-- .work-item-image -->
                  <div class="work-item-info">
              ...
              <li class="work-item interior-design house-renovation">
                <a href="{{ asset('web/assets/img/img-work-05.jpg') }}" title="Jannet Home" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-05.jpg') }}" alt="Jannet Home">
                  </div><!-- .work-item-image -->
                  <div class="work-item-info">
              ...
              <li class="work-item design photography">
                <a href="{{ asset('web/assets/img/img-work-06.jpg') }}" title="Papa Ron's Restaurant" class="image-lightbox">
                  <div class="work-item-image">
                    <img src="{{ asset('web/assets/img/img-work-06.jpg') }}" alt="Papa Ron's Restaurant">
                  </div><!-- .work-item-image -->
                  <div class="work-item-info">
    ...
    <!-- begin:about -->
    <div id="about" class="block-section image-block">
      <div class="container-fluid">
        <div class="row">
          <div class="image-block-item col-md-6 col-sm-5 col-xs-12">
            <div class="image-block-item-background" style="background-image: url("{{ asset('web/assets/img/img-content-01.jpg') }}");"></div>
          ...
          <div class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-10 col-xs-offset-1 padd-80-top padd-60-btm">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade active in" role="tabpanel" id="who" aria-labelledby="who-tab">
                <h2 class="marg-20-btm">Who We Are?</h2>
                <p>Construction, Inc. traces its roots back to 1989 in Orange and since then have never looked back. With thousands of successful projects under our belt, we can proudly say that we are one.</p>
                <p>For more than 25 years, Construction has offered a wide range of construction services in Colorado, many other cities of United States and around the world. We strive to maintain.<br>We aim to eliminate the task of dividing your project between different architecture and construction company.</p>
                <p><a href="#" class="button"><i class="fa fa-wrench"></i> Learn Our Service</a></p>
              </div>
              <div class="tab-pane fade" role="tabpanel" id="why" aria-labelledby="why-tab">
                ...
                <p><a class="button btn-danger popup-video" href="http://www.youtube.com/watch?v=Og879fOk6DQ"><i class="fa fa-play-circle-o"></i> Watch Overview</a></p>
              </div><!-- .tab-pane -->
            </div><!-- .tab-content -->
          </div><!-- .col-## -->
        </div><!-- .row -->
    ...
    <!-- begin:testimonial -->
    <div id="testimonial" class="block-section image-block bg-white">
      <div class="container-fluid container-no-padding">
        <div class="row row-no-margin">
          <div class="image-block-item col-md-6 col-md-offset-6 col-sm-5 col-xs-12">
            <div class="image-block-item-background" style="background-image: url("{{ asset('web/assets/img/img-content-03.jpg') }}");"></div>
          </div><!-- .image-block-item -->
        </div><!-- .row -->
      </div><!-- .container-fluid -->
      <div class="container clear">
        <div class="row">
          <div class="col-md-5 col-md-offset-0 col-sm-7 col-sm-offset-5 padd-60-top padd-100-btm">
            <h2 class="marg-40-btm text-center">What People Says</h2>
            <div class="carousel slide testimony-dark" id="testimony" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  ...
                  <img class="testimony-item-image" src="{{ asset('web/assets/img/img-testimony-01.jpg') }}">
                ...
                <div class="item">
                  ...
                  <img class="testimony-item-image" src="{{ asset('web/assets/img/img-testimony-02.jpg') }}">
    ...
    <div id="contact" class="contact image-block">
      <div class="container-fluid container-no-padding">
        <div class="row row-no-margin">
          <div class="image-block-item col-md-6 col-sm-5 col-xs-12">
            <div class="image-block-item-background image-block-item-map" data-lat="33.7955454" data-lng="-117.8282586"></div>
          </div><!-- .image-block-item -->
        </div><!-- .row -->
      </div><!-- .container-fluid -->
      <div class="container clear">
        <div class="row">
          <div class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-12 col-xs-offset-0 padd-40-top padd-80-btm">
            <form class="contact-form">
              ...
              <button type="submit" class="button btn-squar btn-roundede">Send Message</button>
            </form><!-- .contact-form -->
          </div><!-- .col-## -->
        </div><!-- .row -->
      </div><!-- .container -->
    ...
    <!-- begin:client -->
    <div id="client" class="client block-section bg-white padd-20-top padd-20-btm">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div id="slider-thumbnail" class="owl-carousel owl-theme client-slider slider-carousel navigation-hide">
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-01.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-02.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-03.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-04.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-05.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-06.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-07.png') }}" alt="client">
                </a>
              </div><!-- .item -->
              <div class="item">
                <a href="#">
                  <img src="{{ asset('web/assets/img/img-client-08.png') }}" alt="client">
                </a>
              </div><!-- .item -->
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <section class="widget">
              <img src="{{ asset('web/assets/img/img-logo-footer.png') }}" alt="bootstrap theme for construction companies" class="img-responsive marg-20-btm marg-20-top">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 copy-left">
            <p>Copyright &copy; 2016 <a href="http://templateninja.net"><strong>TemplateNinja</strong></a>. All Right Reserved.</p>
          </div><!-- .col-sm-6 -->
    ...
    <script src="{{ asset('web/assets/plugins/parallax.min.js') }}"></script>
    <script src="{{ asset('web/assets/js/navigation.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/jquery.easing.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('web/assets/plugins/gmap3.min.js') }}"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBtR223ih2ZwVJX2SGBixD3p87Aa8RV2Is"></script>
    <script src="{{ asset('web/assets/js/script.min.js') }}"></script>
  </body>
</html>
