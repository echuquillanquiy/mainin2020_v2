    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        @csrf
          ...
          <div class="input-group mb-3">
            <input id="password" type="password" placeholder="Ingrese Contraseña" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
          ...
          <div class="row">
            <div class="col-8">
              <div class="icheck-primary">
                <input lass="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
